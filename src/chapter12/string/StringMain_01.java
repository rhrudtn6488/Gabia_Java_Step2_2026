...
public class StringMain_01 {
	...
	public static void main(String[] args) {
		...
		// str1 주소 같음
		System.out.println(System.identityHashCode(str1)); // 603856241
		str = str1 + str2;
		System.out.println(System.identityHashCode(str)); // 854507466
		System.out.println(System.identityHashCode(str1)); // 603856241
		System.out.println(str);

		//str1.concat 컴파일시 새로운 객체로 문자열이 변환됨
		str1 = str1.concat(str2);
		System.out.println(System.identityHashCode(str1)); // 1316061703
